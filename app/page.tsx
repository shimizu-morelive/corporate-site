    ...
    <main>
      ...
      <section className="about section" id="about" aria-labelledby="about-title">
        ...
        <div className="about-copy">
          ...
          <h3>TikTok Shopから、ライブコマースをもっと身近に。</h3>
          <p>モアライブは、TikTok Shopを中心に、ライブ配信とショート動画を活用した販売支援を行っています。商品の魅力をリアルタイムで伝え、視聴から購入までがひとつにつながる、新しい購買体験をつくります。</p>
          <p>メーカー・小売事業者の商品と、ライブコマーサーの伝える力を結び、企画・キャスティング・配信・販売・改善まで一貫して支援します。TikTok Shopを一時的な販路ではなく、継続して育つ販売チャネルへ。</p>
        </div>
      </section>
