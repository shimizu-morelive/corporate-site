...
export default function CreatorManagementPage() {
  return (
    <ServiceDetail
      ...
      title={"ライブコマーサー\nマネジメント"}
      lead="モアライブで、売ることを仕事にする。あなたの伝える力が、商品と人をつなぎます。"
      descriptions={[
        "モアライブは、ライブコマースで活躍したい方、ライブコマーサーとしてさらに成長したい方の活動を支援します。",
        "所属してもらうだけの会社ではなく、優秀なコマーサーから『ここで活動したい』と選ばれる環境を目指し、商品・案件・配信環境・報酬機会・キャリアを整えます。",
      ]}
      introTitle={"売ることを\n仕事にする"}
